...
urlpatterns = [
        ...
        path('users/<int:user_id>/change/username/<str:new_username>/', views.change_username, name = "change_username"),
        ...
        path('groups/create/<str:group_name>/', views.create_group, name = "create group"),
